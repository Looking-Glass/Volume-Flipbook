Shader "Volume Flipbook/Color Overlay"
{
    Properties {
	...
	Cull [_Cull]
		...
		CGPROGRAM
			...
			{
				//CHANGE MADE HERE: the _Color is being ADDED rather than multiplied by.
				fixed4 diffuse = tex2D(_MainTex, i.uv) + float4(_Color.xyz, 0);
